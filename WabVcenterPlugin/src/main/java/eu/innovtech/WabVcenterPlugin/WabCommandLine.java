				 ...
				 for (ObjectContent oc : props.getObjects()) {
					 ...
					 if (dps != null) {
						 ...
						 if(vmOs!=null) {
							...
							{
								for(int i=0;i<wab_defaut_windows_service_number;i++) {
									...
									if(i==0) {
										...
										//System.out.println(" DOING =>"+wab_windows_account_0);
										reader.beginArray();
								...
								for(int i=0;i<wab_defaut_linux_service_number;i++) {
									//create the linux service name
									WabDeviceAccount[] newAccount=new WabDeviceAccount[10];
									//System.out.println(" DOING =>"+wab_defaut_linux_service_number+" compt:"+i);
									if(i==0) {
										//gsonObj.toJson(wab_windows_account_0);
										int j=0;
									...
									if(i==1) {
										...
										//System.out.println(" DOING =>"+wab_linux_account_0+" compt:"+i);
										reader.beginArray();
										while (reader.hasNext()) {
											reader.beginObject();
											newAccount[j]=new WabDeviceAccount();
